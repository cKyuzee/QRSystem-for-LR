...
<head>
  <title>CCSLR &mdash; Speakers</title>
  <meta charset="utf-8">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="speaker text-left">
              <a href="speaker-single.php" class="d-block mb-3 thumbnail"><img src="images/speakers/speaker1.jpg" alt="Image" class="img-fluid"></a>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="speaker text-left">
              <a href="speaker-single.php" class="d-block mb-3 thumbnail"><img src="images/speakers/speaker3.jpg" alt="Image" class="img-fluid"></a>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="speaker text-left">
              <a href="speaker-single.php" class="d-block mb-3 thumbnail"><img src="images/speakers/speaker2.jpg" alt="Image" class="img-fluid"></a>
